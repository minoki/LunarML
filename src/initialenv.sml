    ...
    = let open Typing
      ...
      in List.foldl Typing.mergeEnv
                    ...
                    , valMap = union [mkValConMap [(VId_ref, TypeScheme ([(tyVarA, [])], tyA --> refOf tyA)) (* forall 'a. 'a -> 'a ref *)
                                     ...
                                     ,mkValMap [(VId_EQUAL, TypeScheme ([(tyVarA, [IsEqType SourcePos.nullSpan])], mkPairType(tyA, tyA) --> primTy_bool)) (* forall ''a. ''a * ''a -> bool *)
                                               ...
                                               (* Overloaded identifiers *)
                                               ,(VId_abs, TypeScheme([(tyVarA, [IsSignedReal SourcePos.nullSpan])], tyA --> tyA)) (* realint -> realint, default: int -> int *)
                                               ,(VId_TILDE, TypeScheme([(tyVarA, [IsRing SourcePos.nullSpan])], tyA --> tyA)) (* num -> num, default: int -> int *)
                                               ,(VId_div, TypeScheme([(tyVarA, [IsIntegral SourcePos.nullSpan])], mkPairType(tyA, tyA) --> tyA)) (* wordint * wordint -> wordint, default: int * int -> int *)
                                               ,(VId_mod, TypeScheme([(tyVarA, [IsIntegral SourcePos.nullSpan])], mkPairType(tyA, tyA) --> tyA)) (* wordint * wordint -> wordint, default: int * int -> int *)
                                               ,(VId_TIMES, TypeScheme([(tyVarA, [IsRing SourcePos.nullSpan])], mkPairType(tyA, tyA) --> tyA)) (* num * num -> num, default: int * int -> int *)
                                               ,(VId_DIVIDE, TypeScheme([(tyVarA, [IsField SourcePos.nullSpan])], mkPairType(tyA, tyA) --> tyA)) (* Real * Real -> Real, default: real * real -> real *)
                                               ,(VId_PLUS, TypeScheme([(tyVarA, [IsRing SourcePos.nullSpan])], mkPairType(tyA, tyA) --> tyA)) (* num * num -> num, default: int * int -> int *)
                                               ,(VId_MINUS, TypeScheme([(tyVarA, [IsRing SourcePos.nullSpan])], mkPairType(tyA, tyA) --> tyA)) (* num * num -> num, default: int * int -> int *)
                                               ,(VId_LT, TypeScheme([(tyVarA, [IsOrdered SourcePos.nullSpan])], mkPairType(tyA, tyA) --> primTy_bool)) (* numtxt * numtxt -> bool, default: int * int -> bool *)
                                               ,(VId_GT, TypeScheme([(tyVarA, [IsOrdered SourcePos.nullSpan])], mkPairType(tyA, tyA) --> primTy_bool)) (* numtxt * numtxt -> bool, default: int * int -> bool *)
                                               ,(VId_LE, TypeScheme([(tyVarA, [IsOrdered SourcePos.nullSpan])], mkPairType(tyA, tyA) --> primTy_bool)) (* numtxt * numtxt -> bool, default: int * int -> bool *)
                                               ,(VId_GE, TypeScheme([(tyVarA, [IsOrdered SourcePos.nullSpan])], mkPairType(tyA, tyA) --> primTy_bool)) (* numtxt * numtxt -> bool, default: int * int -> bool *)
