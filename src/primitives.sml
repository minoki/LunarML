...
fun isDiscardable EQUAL = true
  ...
  | isDiscardable Int_GE = true
  | isDiscardable Word_EQUAL = true
  | isDiscardable Word_PLUS = true
  ...
  | isDiscardable String_size = true
  ...
  | isDiscardable String16_size = true
  ...
  | isDiscardable Vector_length = true
  | isDiscardable Vector_unsafeFromListRevN = true
  | isDiscardable Array_EQUAL = true
  | isDiscardable Array_length = true
  | isDiscardable Unsafe_cast = true
  | isDiscardable Unsafe_Vector_sub = true
  | isDiscardable Unsafe_Array_sub = true
  | isDiscardable Unsafe_Array_update = false
