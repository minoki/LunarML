...
struct
  ...
  fun setAllowExtendedConsts value : options -> options =
    set.allowExtendedNumConsts value o set.allowExtendedTextConsts value
  fun setAllowVectorExpsAndPats value : options -> options =
    set.allowVectorExps value o set.allowVectorPats value
  fun setAllowSuccessorML value : options -> options =
    set.allowDoDecls value o set.allowExtendedNumConsts value
    o set.allowExtendedTextConsts value o set.allowLineComments value
    o set.allowOptBar value o set.allowOptSemicolon value
    o set.allowRecordPunExps value o set.allowSigWithtype value
    o set.allowRecordExtension value o set.allowRecordUpdate value
    o set.allowValRecTyVars value o set.allowValTyVarsRec (not value)
