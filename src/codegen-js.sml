           ...
           in case dec of
                ...
                | C.ValDec { exp = C.PrimOp { primOp = F.PrimFnOp prim, tyargs, args }, result } =>
                  ...
                  in case prim of
                       ...
                       | Primitives.Int_EQUAL _ => doBinaryOp (J.EQUAL, PURE)
                       ...
                       | Primitives.Int_rem Primitives.I32 => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_rem"), vector [a, b]), IMPURE)
                       | Primitives.Int_rem_unchecked Primitives.I32 => doBinaryExp (fn (a, b) => J.ToInt32Exp (J.BinExp (J.MOD, a, b)), PURE)
                       | Primitives.Int_LT _ => doBinaryOp (J.LT, PURE)
                       | Primitives.Int_GT _ => doBinaryOp (J.GT, PURE)
                       | Primitives.Int_LE _ => doBinaryOp (J.LE, PURE)
                       | Primitives.Int_GE _ => doBinaryOp (J.GE, PURE)
