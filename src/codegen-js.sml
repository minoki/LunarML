           ...
           in case dec of
                ...
                | C.ValDec { exp = C.PrimOp { primOp = F.PrimFnOp prim, tyargs, args }, result } =>
                  ...
                  in case prim of
                       ...
                       | Primitives.Int_PLUS => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_add"), vector [a, b]), IMPURE)
                       | Primitives.Int_MINUS => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_sub"), vector [a, b]), IMPURE)
                       | Primitives.Int_TIMES => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_mul"), vector [a, b]), IMPURE)
                       | Primitives.Int_div => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_div"), vector [a, b]), IMPURE)
                       | Primitives.Int_mod => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_mod"), vector [a, b]), IMPURE)
                       | Primitives.Int_quot => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_quot"), vector [a, b]), IMPURE)
                       | Primitives.Int_rem => doBinaryExp (fn (a, b) => J.CallExp (J.VarExp (J.PredefinedId "_Int32_rem"), vector [a, b]), IMPURE)
