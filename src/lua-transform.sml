...
val mlinit_lua = List.foldl (fn (name, m) => L.IdMap.insert (m, L.PredefinedId name, L.CONST)) L.IdMap.empty
                            ["_ENV","assert","error","getmetatable","pairs","pcall","setmetatable","math","math_abs","math_type","math_maxinteger","math_mininteger","math_ult","string","string_char","string_format","table","table_pack","table_unpack","_id","_exn_meta","_Match_tag","_Match","_Bind_tag","_Bind","_Overflow_tag","_Overflow","_Div_tag","_Div","_Size_tag","_Size","_Subscript_tag","_Subscript","_Fail_tag","_Fail","_LuaError_tag","_LuaError","_handle","_exnName","__exn_instanceof","_raise","__Int_add","__Int_sub","__Int_mul","__Int_div","__Int_mod","_Int_negate","_Int_abs","__Word_div","__Word_mod","_list","_Array_array","_VectorOrArray_fromList","_Vector_unsafeFromListRevN","_VectorOrArray_tabulate","_Vector_concat","_Lua_function"]
val mlinit_luajit = List.foldl (fn (name, m) => L.IdMap.insert (m, L.PredefinedId name, L.CONST)) L.IdMap.empty
                            ["_G","assert","error","getmetatable","pairs","pcall","setmetatable","math","math_abs","math_floor","math_modf","string","string_char","string_format","table","select","table_pack","table_unpack","bit","bit_lshift","bit_rshift","_id","_exn_meta","_Match_tag","_Match","_Bind_tag","_Bind","_Overflow_tag","_Overflow","_Div_tag","_Div","_Size_tag","_Size","_Subscript_tag","_Subscript","_Fail_tag","_Fail","_LuaError_tag","_LuaError","_handle","_exnName","__exn_instanceof","_raise","MIN_INT32","MAX_INT32","__Int_add","__Int_sub","__Int_mul","__Int_div","__Int_quot","__Int_mod","_Int_negate","_Int_abs","__Word_add","__Word_sub","__Word_mul","__Word_div","__Word_mod","_Word_negate","NEGATIVE_ZERO","__Real_mul","_list","_Array_array","_VectorOrArray_fromList","_Vector_unsafeFromListRevN","_VectorOrArray_tabulate","_Vector_concat","_Lua_function"]
