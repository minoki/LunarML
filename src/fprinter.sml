...
and doDec (F.ValDec (vid, SOME ty, exp)) = P.Fragment "val " :: P.Fragment (USyntax.print_VId vid) :: P.Fragment " : " :: doTy 0 ty @ P.Fragment " = " :: doExp 0 exp
  | doDec (F.ValDec (vid, NONE, exp)) = P.Fragment "val " :: P.Fragment (USyntax.print_VId vid) :: P.Fragment " : _ = " :: doExp 0 exp
