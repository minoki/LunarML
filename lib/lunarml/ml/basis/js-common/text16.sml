...
fun contains (s : String16.string) (c : Char16.char) : bool
    = JavaScript.unsafeFromValue (JavaScript.method (JavaScript.fromString16 s, "includes") #[JavaScript.fromString16 (String16.str c)])
...
fun sub (s : String16.string, i : int) : Char16.char = JavaScript.unsafeFromValue (JavaScript.method (JavaScript.fromString16 s, "charCodeAt") #[JavaScript.fromInt i])
end;
...
fun substring (s : String16.string, i : int, j : int) : String16.string
    = if i < 0 orelse j < 0 orelse String16.size s < i + j then
          ...
          JavaScript.unsafeFromValue (JavaScript.method (JavaScript.fromString16 s, "substring") #[JavaScript.fromInt i, JavaScript.fromInt (i + j)])
fun extract (s : String16.string, i : int, NONE : int option) : String16.string
    = if i < 0 orelse String16.size s < i then
          raise Subscript
      else
          JavaScript.unsafeFromValue (JavaScript.method (JavaScript.fromString16 s, "substring") #[JavaScript.fromInt i])
  | extract (s, i, SOME j) = substring (s, i, j)
fun concat (l : String16.string list) : String16.string
    = let val v = Vector.fromList l
      in JavaScript.unsafeFromValue (JavaScript.method (JavaScript.unsafeToValue v, "join") #[JavaScript.fromString16 ""])
      end
fun concatWith (s : String16.string) (l : String16.string list) : String16.string
    = let val v = Vector.fromList l
      in JavaScript.unsafeFromValue (JavaScript.method (JavaScript.unsafeToValue v, "join") #[JavaScript.fromString16 s])
      end
fun implodeRev (l : Char16.char list) : String16.string
    = let val v = _primCall "Vector.unsafeFromListRevN" (List.length l, l)
          val v = Vector.map String16.str v
      in JavaScript.unsafeFromValue (JavaScript.method (JavaScript.unsafeToValue v, "join") #[JavaScript.fromString16 ""])
      end
...
fun explode (s : String16.string) : Char16.char list
    = List.tabulate (String16.size s, fn i => sub (s, i))
...
fun isSubstring needle haystack : bool = JavaScript.unsafeFromValue (JavaScript.method (JavaScript.fromString16 haystack, "includes") #[JavaScript.fromString16 needle])
...
structure UnsafeChar16Vector = Text16Impl.UnsafeCharVector;
structure UnsafeChar16Array = Text16Impl.UnsafeCharArray;
