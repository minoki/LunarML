...
fun scanOptExpPart (getc, strm, revAcc) = case getc strm of
                                              SOME (c, strm') => if c = #"e" orelse c = #"E" then
                                                                     ...
                                                                     (revAcc, strm)
                                            | NONE => (revAcc, strm)
fun toNumber s = let val result = JavaScript.call JavaScript.Lib.parseFloat #[JavaScript.fromWideString (JavaScript.decodeUtf8 s)]
                 in JavaScript.unsafeFromValue result : real
                 end
