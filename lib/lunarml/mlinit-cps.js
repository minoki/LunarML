...
function _isMatch(k, e) { return [false, k, [e instanceof _Match_tag]]; }
//END
//BEGIN _Bind_tag
function _Bind_tag() {}
...
function _isBind(k, e) { return [false, k, [e instanceof _Bind_tag]]; }
//END
//BEGIN _Div_tag
function _Div_tag() {}
...
function _isDiv(k, e) { return [false, k, [e instanceof _Div_tag]]; }
//END
//BEGIN _Overflow_tag
...
function _isOverflow(k, e) { return [false, k, [e instanceof _Overflow_tag]]; }
//END
//BEGIN _Size_tag
function _Size_tag() {}
...
function _isSize(k, e) { return [false, k, [e instanceof _Size_tag]]; }
//END
...
function _isSubscript(k, e) { return [false, k, [e instanceof _Subscript_tag]]; }
//END
//BEGIN _Fail_tag
...
function _isFail(k, e) { return [false, k, [e instanceof _Fail_tag]]; }
//END
//BEGIN _Fail_payload
function _Fail_payload(k, e) { return [false, k, [e.payload]]; }
//END
//BEGIN _id
function _id(k, x) { return [false, k, [x]]; }
//END
//BEGIN _isError
function _isError(k, e) { return [false, k, [!("__isMLExn" in e)]]; }
//END
//BEGIN _mkFn2
function _mkFn2(f) {
  return (k, a, b) => [false, f, [k, [a, b]]];
}
//END
//BEGIN _mkFn3
function _mkFn3(f) {
  return (k, a, b, c) => [false, f, [k, [a, b, c]]];
}
//END
//BEGIN _String_EQUAL
...
function _String_concatWith(k, sep, xs) {
    let n = 0;
    let xs0 = xs;
    while (xs0 !== null) {
        const s = xs0[0];
...
function _String32_concatWith(k, sep, xs) {
    let n = 0;
    let xs0 = xs;
    while (xs0 !== null) {
        const s = xs0[0];
